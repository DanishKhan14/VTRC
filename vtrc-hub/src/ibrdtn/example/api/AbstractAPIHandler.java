...
import in.vtrc.hub.lib.vtrcHandler;
import in.vtrc.hub.lib.vtrcHandler.Context;
...
public class AbstractAPIHandler implements ibrdtn.api.sab.CallbackHandler {
    ...
    protected vtrcHandler hndlr;
    protected Bundle bundle = null;
    protected Thread t;
    protected byte[] bytes;

    public AbstractAPIHandler(ExtendedClient exClient, ExecutorService executor, vtrcHandler hndlr) {
