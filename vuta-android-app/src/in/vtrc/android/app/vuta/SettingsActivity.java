...
public class SettingsActivity extends PreferenceActivity {
	...
	private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
		...
		public boolean onPreferenceChange(Preference preference, Object value) {
			...
			Log.d("Settings vuta", "Preference key: " + preference.getKey() + " with value: " + stringValue);
			if(preference.getKey().equals("hub_address")) {
				intent.setAction("vtrc.vuta.hubAddressUpdate");
				intent.putExtra("hubAddress", stringValue);
				Log.d("Settings vuta", "Setting hub address in intent as: " + stringValue);
			} else if(preference.getKey().equals("my_identity")) {
				intent.setAction("vtrc.vuta.myIdentityUpdate");
				intent.putExtra("myIdentity", stringValue);
				Log.d("Settings vuta", "Setting identity in intent as: " + stringValue);
			}
			preference.getContext().sendBroadcast(intent);
			Log.d("vuta", "Sent broadcast with intent: " + intent.toString() + " Extras: " + intent.getExtras());
			return true;
		}
	};
